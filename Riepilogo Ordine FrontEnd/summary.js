...
const riepilogoDivSection = document.createElement('div');
riepilogoDivSection.className = 'shippingInfo';
const filteredProducts = totalProducts.filter(product => shoppingInfo.hasOwnProperty(product.code));
let counter = 0;
...
const billingInfoDiv = document.createElement('div');
